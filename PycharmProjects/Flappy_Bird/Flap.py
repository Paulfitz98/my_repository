...
def pipe_score_check():
    ...
    if pipe_list:
        for pipe in pipe_list:
            if 99 < pipe.centerx < 102 and can_score:
                score += 1
                point_sound.play()
...
bird_downflap = pygame.transform.scale2x(pygame.image.load('assets/sprites/redbird-downflap.png').convert_alpha())
bird_midflap = pygame.transform.scale2x(pygame.image.load('assets/sprites/redbird-midflap.png').convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load('assets/sprites/redbird-upflap.png').convert_alpha())
...
pipe_surface = pygame.image.load('assets/sprites/pipe-red.png')
